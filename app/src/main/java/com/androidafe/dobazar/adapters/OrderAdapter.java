...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.CartViewHolder>{
    ...
    public OrderAdapter(List<Carts> carts, Context context, TextView totalPriceTextView) {
        this.carts = carts;
    ...
    public void onBindViewHolder(@NonNull CartViewHolder holder, int position) {
        ...
        holder.binding.pPrice.setText(String.valueOf(cart.getProductPrice()) + " vnd");
        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                ((Activity) context).runOnUiThread(() -> {
                    ...
                    totalPriceTextView.setText(String.format("%.2f", totalPrice) + " vnd");
                });
            }
        });
    }
